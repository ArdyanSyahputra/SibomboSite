	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="{{route('daftar.store')}}" method="post">
                @csrf
					...
					<div class="wrap-input100 validate-input" data-validate = "Nama Kamu">
						<input class="input100" type="text" name="nama" id="nama" placeholder="Masukkan Nama Lengkap">
					...
					<div class="wrap-input100 validate-input" data-validate="username is required">
						<input class="input100" type="text" name="username" id="username" placeholder="Masukkan Username yang Unik">
						<span class="focus-input100"></span>
						<span class="label-input100"></span>
					</div>
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						<input class="input100" type="email" name="email" id="email" placeholder="Masukkan Email, Contoh : abc@gmail.com">
						<span class="focus-input100"></span>
						<span class="label-input100"></span>
					</div>
					...
					<div class="wrap-input100 validate-input" data-validate="Password is required">
						<input class="input100" type="password" name="password" id="password" placeholder="Masukkan passsword">
						<span class="focus-input100"></span>
						<span class="label-input100"></span>
					</div>

                    <label for="name">Level</label>
                    <div class="wrap-input100 validate-input" data-validate = "level">
						<input class="input100" type="text" name="level" id="level" placeholder="Masukkan Level">
						<span class="focus-input100"></span>
						<span class="label-input100"></span>
					</div>
					...
					<div class="wrap-input100 validate-input" data-validate="Status">
						<input class="input100" type="text" name="status" id="status" placeholder="Masukkan Status">
						<span class="focus-input100"></span>
						<span class="label-input100"></span>
					</div>
					...
					<div class="text-center p-t-46 p-b-20">
						<span class="txt2" >
                        Sudah Punya Akun? <a href="{{ route('login') }}" target="_blank" >Login Disini</a>
						</span>
